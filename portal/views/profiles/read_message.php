...
<i style="font-size:8pt;color:#666666;font-style:italic;"><?php echo $timestamp; ?></i>
<hr />
...
<div style="display:none;">
    ...
    <fieldset>
        <table>
            ...
            <tr>
                <td>&nbsp;</td>
                <td><?php echo form_textarea('message','Quote : "'.html_entity_decode($message).'"<br />----------<br />',"style='width:98%;height:600px;' class='tinymce' ")?></td>                
            </tr>            
            <tr>
