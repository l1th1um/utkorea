...
$file_root = '../images/announcements'; 		//where to store files, must be created and writable
$root_path = 'http://localhost/utkorea/assets/core'; 					//path from webroot, without trailing slash. If your page is located in http://www.example.com/john/, this should be '/john'
...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $root_path; ?>/js/tiny_mce/themes/advanced/skins/default/dialog.css" type="text/css" />
  <script type="text/javascript" src="<?php echo $root_path; ?>/js/tiny_mce/tiny_mce_popup.js"></script>
